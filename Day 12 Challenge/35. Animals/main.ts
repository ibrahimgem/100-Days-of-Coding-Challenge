...
//Declaring array for three animals and printing each of them with for loop.
...
// Printing each of animal with sentences through for loop.

    animals.forEach(animal => {
        console.log(`A ${animal} would make a great pet.`);       
    });

console.log(`These animals would be very friendly.`);
