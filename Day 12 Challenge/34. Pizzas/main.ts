...
//Declaring array for three pizzas and printing each of them with for loop.

let pizzas: string[] = ['Cheese', 'BBQ', 'Pepperoni'];

    pizzas.forEach(pizza => {
        console.log(pizza);
    })

// Printing each of pizza with sentences through for loop.
